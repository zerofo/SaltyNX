...
extern u32 SaltySDCore_getCodeStart() LINKABLE;
extern u64 SaltySDCore_getCodeSize() LINKABLE;
extern u32 SaltySDCore_findCode(u8* code, size_t size) LINKABLE;
extern u32 SaltySDCore_findCodeEx(u8* code, size_t size) LINKABLE;
