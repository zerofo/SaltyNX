 ...
 */
Result svcMapMemory(void* dst_addr, void* src_addr, u32 size);
 ...
 */
Result svcUnmapMemory(void* dst_addr, void* src_addr, u32 size);
 ...
 */
Result svcQueryMemory(MemoryInfo* meminfo_ptr, u32 *pageinfo, u32 addr);
